...
def build_model(params):
	...
	AE = Sequential()
	AE.add(CuDNNLSTM(params['units'],batch_input_shape=( params['batch_size'],timesteps, input_dim),stateful = False))
	...
	new_model.add(CuDNNLSTM(params['units'],batch_input_shape=( 1,timesteps, input_dim),stateful = False))
	new_model.add(Dropout(params['dropout']))
